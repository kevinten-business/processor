 ...
 */
public enum ProcessorErrorCodes implements ProcessorErrorCodeContext {
    ...
    ProcessorErrorCodes(String code, String message) {
        this.code = code;
    ...
    static {
        ErrorCodeManager.assertErrorCodesNoDuplicate(ProcessorErrorCodes.values());
    }
    ...
    public static void showErrorCodes() {
        MANAGER.showErrorCodes(ProcessorErrorCodes.values());
    }
}
